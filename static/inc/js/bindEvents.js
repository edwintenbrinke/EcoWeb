function bindAllElectionEvents (election) {
  const specificElection = getURLParameter('election')
  ...
  $(document).on('click', '.show-votes-round', function () {
    ...
    const guid = $('.previous-election.active-election').data('guid')
  ...
  $(document).on('click', '#remove-self', function () {
    ...
    const count = $('.vote .vote-item select').length
