    ...
    init (options, chart, firstAxis) {
      ...
      if (backgroundOption) {
        each([].concat(splat(backgroundOption)).reverse(), function (config) {
          ...
          const axisUserOptions = firstAxis.userOptions
 ...
 */
  ...
  const radialAxisMixin = {
    ...
    setOptions (userOptions) {
      const options = this.options = merge(
        this.defaultOptions,
 ...
 */
  wrap(tickProto, 'getLabelPosition', function (proceed, x, y, label, horiz, labelOptions, tickmarkOffset, index, step) {
    ...
    let ret
    let centerSlot = 20 // 20 degrees to each side at the top and bottom
 ...
 */
  seriesTypes.arearange = extendClass(seriesTypes.area, {
    ...
    highToXY (point) {
      ...
      const chart = this.chart
      const xy = this.xAxis.postTranslate(point.rectPlotX, this.yAxis.len - point.plotHigh)
    ...
    drawDataLabels () {
      ...
      const align = dataLabelOptions.align
      const inside = dataLabelOptions.inside
      let point
      let up
 ...
 */
  const GaugePoint = extendClass(Point, {
    /**
 ...
 *****************************************************************************/
  ...
  seriesTypes.boxplot = extendClass(seriesTypes.column, {
    ...
    drawPoints () {
      ...
      let pointWiskerLength
      const whiskerLength = series.options.whiskerLength
 ...
 *****************************************************************************/
  ...
  seriesTypes.waterfall = extendClass(seriesTypes.column, {
    ...
    processData (force) {
      ...
      const points = series.options.data // #3710 Update point does not propagate to sum
      let point
    ...
    getAttribs () {
      ...
      const hoverColor = Highcharts.Color(upColor).brighten(0.1).get()
    ...
    getGraphPath () {
      const data = this.data
      const length = data.length
      const lineWidth = this.options.lineWidth + this.borderWidth
 ...
 *****************************************************************************/
  ...
  const BubblePoint = extendClass(Point, {
    haloPath () {
  ...
  seriesTypes.bubble = extendClass(seriesTypes.scatter, {
    ...
    getRadii (zMin, zMax, minSize, maxSize) {
      ...
      const radii = []
      const options = this.options
      const sizeByArea = options.sizeBy !== 'width'
      const zThreshold = options.zThreshold
 ...
 *****************************************************************************/
  ...
  (function () {
    ...
    seriesProto.searchPointByAngle = function (e) {
      ...
      const center = xAxis.pane.center
      const plotX = e.chartX - center[0] - chart.plotLeft
      const plotY = e.chartY - center[1] - chart.plotTop
      ...
      wrap(seriesTypes.spline.prototype, 'getPointSpline', function (proceed, segment, point, i) {
        ...
        if (this.chart.polar) {
          ...
          if (lastPoint && nextPoint) {
            ...
            distanceLeftControlPoint = Math.sqrt((leftContX - plotX) ** 2 + (leftContY - plotY) ** 2)
            distanceRightControlPoint = Math.sqrt((rightContX - plotX) ** 2 + (rightContY - plotY) ** 2)
          ...
          ret[isXAxis ? 'xAxis' : 'yAxis'].push({
            ...
            value: axis.translate(
              isXAxis
                ...
                : Math.sqrt(x ** 2 + y ** 2), // distance from center
              true
            )
          })
        })
