  ...
  <div class="map-controls-wrapper">
    ...
    <div class="range-controls-wrapper">
      <div class="map-progress-bar-wrapper">
        <progress id="map-progress-bar" value="0.75" max="1.0" />
      </div>
    ...
    <div class="speed-controls-wrapper">
      <div id="speed-button">
        <span class="speed-button">0.5</span><br><span class="localize" translate-key="70">days/sec</span>
      </div>
      <input
        id="map-play-speed"
        type="range"
